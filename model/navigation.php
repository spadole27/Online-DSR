         ...
         <nav class="navbar navbar-inverse navbar-fixed-top" id="navbar-inverse">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="color: white;">
                    ...
                    <li><a class="<?php if($currentPage =='index.php'){echo 'active';}?>" href="xampp\htdocs\online_dsr\item_entry_form\index.php">Item Entry</a></li>
                    <li><a class="<?php if($currentPage =='product.php'){echo 'active';}?>" href="item_request_form/index.php">Item Request</a></li>
